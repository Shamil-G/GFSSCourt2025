...
//////////////////////////////////////////////////////////////////////////////
export function getSharedOrderNum() {
...
export function setSharedTabId(tabName) {
    const shared = document.getElementById('sharedTabId');
    if (shared) {
        shared.value = tabName;
        return tabName;
    } else {
        console.warn('⚠️ setSharedTabId: элемент sharedTabId не найден');
        return null;
    }
}
export function getSharedTabId() {
    return document.getElementById('sharedTabId')?.value || '';
}
